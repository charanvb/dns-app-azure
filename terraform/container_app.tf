...
# ══════════════════════════════════════════════════════════════════════════════
# Development Container App REMOVED
# 
# The dev container app has been replaced with Azure App Service for better
# VNet integration and PostgreSQL connectivity.
# See: terraform/app_service.tf
# ══════════════════════════════════════════════════════════════════════════════
